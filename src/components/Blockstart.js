...
function Blockstart(props) {
  ...
  return (
    ...
    >
      <div>
        {props.blockType === "training" && props.currentMiniblock === 0 ? <div>Nous allons d'abord vous montrer quelques exemples d'essais d'apprentissage.<br/><br/></div>  : null}
        {props.blockType === "test" && props.currentMiniblock === 0 ? <div>Nous allons maintenant vous montrer quelques exemples d'essais de test.<br/><br/></div>  : null}
        {props.blockType === "training" && props.currentMiniblock === 1 ? <div>Nous allons maintenant commencons le premier bloc<br/><br/></div>  : null}
